...
NAME_OK = "```Your name is succesfully changed.```"
USERNAME_SUCCESS = "```Your username is succesfully changed.```"
USERNAME_TAKEN = "```Sed..! This username is already taken.```"
# ===============================================================
...
async def _(event):
    ...
    try:
        ...
        await event.edit("My name is changed successfully")
    ...
    try:
        ...
        if photo:
            ...
            try:
                ...
                await event.edit("My profile picture is succesfully changed")
    try:
        os.remove(photo)
    except Exception as e:  # pylint:disable=C0103,W0703
