...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m SuperBot`",
        "**State changed from starting to up**",
        "__INFO:SuperBot: Logged in as 581993043__",
        "__INFO:SuperBot: Successfully loaded all plugins__",
        "__INFO:SuperBot: Successfully deployed Telegram v69.6.9 to Heroku__",
        "__INFO:SuperBot: Processing the App__",
        "**Build Succeeded**",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
